...
ALTER TABLE Dim_Cliente COMMENT 'Tabela de dimensao Cliente';
...
CREATE TABLE Fato_004 (
                ...
                PRIMARY KEY (Cod_Tempo, Cod_Cliente, Cod_Produto, Cod_Organizacional)
);
...
CREATE TABLE Fato_003 (
                ...
                PRIMARY KEY (Cod_Tempo, Cod_Fabrica)
);
...
CREATE TABLE Fato_002 (
                ...
                PRIMARY KEY (Cod_Produto, Cod_Tempo, Cod_Cliente, Cod_Fabrica)
);
...
CREATE TABLE Fato_001 (
                ...
                PRIMARY KEY (Cod_Fabrica, Cod_Cliente, Cod_Tempo, Cod_Produto, Cod_Organizacional)
);
...
ALTER TABLE Fato_005 ADD CONSTRAINT dim_produto_tabela_de_fato_005_fk
FOREIGN KEY (Cod_Produto)
REFERENCES Dim_Produto (Cod_Produto)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE Fato_005 ADD CONSTRAINT dim_tempo_tabela_de_fato_005_fk
FOREIGN KEY (Cod_Tempo)
REFERENCES Dim_Tempo (Cod_Tempo)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE Fato_005 ADD CONSTRAINT dim_fabrica_tabela_de_fato_005_fk
FOREIGN KEY (Cod_Fabrica)
REFERENCES Dim_Fabrica (Cod_Fabrica)
ON DELETE NO ACTION
ON UPDATE NO ACTION;